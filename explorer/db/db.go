...
type Accessor interface {
	...
	EpochIdentitiesCount(epoch uint64, states []string) (uint64, error)
	EpochIdentities(epoch uint64, states []string, startIndex uint64, count uint64) ([]types.EpochIdentitySummary, error)
